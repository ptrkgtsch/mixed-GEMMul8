...
template <typename T>
__forceinline__ __device__ T inverse_scaling_1_base(const size_t idx,
                                     const size_t col,
                                     const size_t row,
...
__forceinline__ __device__ T inverse_scaling_1_base_C(
                                     ...
                                     const int16_t *const __restrict__ sftB) // exponent of shift values for cols of B
{
    const auto mem_idx = col * (2 * m) + row;
...
template <typename T>
__forceinline__ __device__ T inverse_scaling_2_base(const size_t idx,
                                     const size_t col,
                                     const size_t row,
                                     const unsigned num_moduli,
                                     const size_t m,                         // size(C64f,1)
                                     ...
                                     const int16_t *const __restrict__ sftB) // exponent of shift values for cols of B
{
    ...
    const T tmpC = inverse_scaling_1_base<T>(idx, col, row, num_moduli, m, incC8u, C8u, invM, M, sftA, sftB);
                                     ...
                                     const int16_t *const __restrict__ sftB) // exponent of shift values for cols of B
{
    ...
    const T tmpC = inverse_scaling_1_base_C<T>(col, row, num_moduli, m, incC8u, C8u, invM, M, sftA, sftB);
                                     ...
                                     const int16_t *const __restrict__ sftB) // exponent of shift values for cols of B
{
    ...
    const T tmpC2 = inverse_scaling_2_base<T>(idx, col, row, num_moduli, m, incC8u, C8u, invM, M1, M2, sftA, sftB);
                                     ...
                                     const int16_t *const __restrict__ sftB) // exponent of shift values for cols of B
{
    ...
    const T tmpC2 = inverse_scaling_2_base_C<T>(col, row, num_moduli, m, incC8u, C8u, invM, M1, M2, sftA, sftB);
                                ...
                                const T beta)              //
{
    ...
    if (alpha == 1.0F) {
        if (beta == 0.0F) {
            inverse_scaling_1_10<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M, sftA, sftB);
        } else if (beta == 1.0F) {
            inverse_scaling_1_11<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M, sftA, sftB);
        } else {
            inverse_scaling_1_1b<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(beta, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M, sftA, sftB);
        }
    } else {
        if (beta == 1.0F) {
            inverse_scaling_1_a1<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(alpha, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M, sftA, sftB);
        } else {
            inverse_scaling_1_ab<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(alpha, beta, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M, sftA, sftB);
        }
    }
}
                                ...
                                const T beta)              //
{
    ...
    if (oz2_type_utils::Creal(alpha) == 1.0F && oz2_type_utils::Cimag(alpha) == 0.0F) {
        if (oz2_type_utils::Creal(beta) == 0.0F && oz2_type_utils::Cimag(beta) == 0.0F) {
            inverse_scaling_1_10_C<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M, sftA, sftB);
        } else if (oz2_type_utils::Creal(beta) == 1.0F && oz2_type_utils::Cimag(beta) == 0.0F) {
            inverse_scaling_1_11_C<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M, sftA, sftB);
        } else {
            inverse_scaling_1_1b_C<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(beta, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M, sftA, sftB);
        }
    } else {
        if (oz2_type_utils::Creal(beta) == 1.0F && oz2_type_utils::Cimag(beta) == 0.0F) {
            inverse_scaling_1_a1_C<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(alpha, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M, sftA, sftB);
        } else {
            inverse_scaling_1_ab_C<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(alpha, beta, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M, sftA, sftB);
        }
    }
}
                                ...
                                const T beta)              //
{
    ...
    if (is_numM_1) {
        ...
        if (alpha == 1.0) {
            if (beta == 0.0) {
                inverse_scaling_2_10<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M1, M2, sftA, sftB);
            } else if (beta == 1) {
                inverse_scaling_2_11<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M1, M2, sftA, sftB);
            } else {
                inverse_scaling_2_1b<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(beta, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M1, M2, sftA, sftB);
            }
        } else {
            if (beta == 1.0) {
                inverse_scaling_2_a1<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(alpha, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M1, M2, sftA, sftB);
            } else {
                inverse_scaling_2_ab<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(alpha, beta, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M1, M2, sftA, sftB);
            }
        }
    }
}
                                ...
                                const T beta)              //
{
    ...
    if (is_numM_1) {
        ...
        if (oz2_type_utils::Creal(alpha) == 1.0 && oz2_type_utils::Cimag(alpha) == 0.0) {
            if (oz2_type_utils::Creal(beta) == 0.0 && oz2_type_utils::Cimag(beta) == 0.0) {
                inverse_scaling_2_10_C<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M1, M2, sftA, sftB);
            } else if (oz2_type_utils::Creal(beta) == 1.0 && oz2_type_utils::Cimag(beta) == 0.0) {
                inverse_scaling_2_11_C<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M1, M2, sftA, sftB);
            } else {
                inverse_scaling_2_1b_C<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(beta, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M1, M2, sftA, sftB);
            }
        } else {
            if (oz2_type_utils::Creal(beta) == 1.0 && oz2_type_utils::Cimag(beta) == 0.0) {
                inverse_scaling_2_a1_C<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(alpha, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M1, M2, sftA, sftB);
            } else {
                inverse_scaling_2_ab_C<T><<<oz2_const::grids_invscaling, oz2_const::threads_invscaling>>>(alpha, beta, num_moduli, m, sizeC, incC8u, C8u, C, ldc, invM, M1, M2, sftA, sftB);
            }
        }
    }
}
